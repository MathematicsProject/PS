...
public class OtsuTreshouter
{
	...
	public static void exec(String inputFile, String outputPrefix, int granularity_start, int granularity_end, String outputpath)
	{
		File actual = new File(inputFile);
		System.out.println("Selected file: " + actual.getAbsolutePath());
		String fullpath = outputpath+outputPrefix;
		...
		try
		{
			...
			for(i = min_passes; i < max_passes; i++)
			{
				...
				File outputImageFile = new File(fullpath);
